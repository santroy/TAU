...
public class VectorTest {
	...
	@Test
	public void subVectorSuccessTest() {
		...
		List<Double> vector2Values = new ArrayList<Double>();
		List<Double> expectedValue = new ArrayList<Double>();
		expectedValue.add(0.0);
		
		
		vector1Values.add(1.3);
		vector2Values.add(1.3);
		
		vector1.setVectorValues(vector1Values);
		vector2.setVectorValues(vector2Values);
		
		assertEquals(expectedValue, vector1.subVector(vector2).getVectorValues());
			
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void subVectorFailTest() {
